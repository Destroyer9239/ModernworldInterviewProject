...
export const STORY_SECTIONS: StorySection[] = [
  {
    ...
    context:
      'Steve Simpson was born in 1967 -- arriving at the height of the Cold War. Growing up in a Navy family, the global conflict wasn\'t something you read about in the papers; it was the heavy silence at the dinner table and the empty chair when Dad was out on another six-month deployment.',
    findings: [
      ...
      'His parents divorced when Steve was six, a casualty of the constant strain and distance of military life.',
      'By age ten, Steve began to notice the invisible wall between the base and the city. The military families spoke a language of duty that the civilian world didn\'t understand.',
      'The veterans came home to a country that felt like it had turned its back on them, creating a divide that defined Steve\'s upbringing.',
    ],
  ...
  },
  {
    ...
    context:
      'Vietnam was a quiet war at home, until it wasn\'t. While the civilian world was turning its back, the Navy was projecting power from carriers in the Gulf of Tonkin. For Steve\'s family, it meant listening to the President on the radio and waiting for a letter that might never come.',
    findings: [
      'Steve\'s father flew on the very first strike of the Vietnam War, launching from the deck of a carrier into the unknown.',
      '"I remember my mom hearing the President announce it." Steve later found the news clippings that matched his mother\'s terrified expression.',
  ...
  },
  {
    ...
    findings: [
      'Steve grew up in the shadow of Coronado NAS in San Diego, where the sound of jets was the soundtrack of his life.',
      ...
      'After the divorce, custody visits meant long trips to Montana. Steve thought his dad was just working a desk job.',
  ...
  },
  {
    ...
    findings: [
      ...
      'CLINTON: Prosperity arrived, but the military felt sidelined. "He gave Saturday Night Live a lot of material," Steve recalls with a grin.',
      'BUSH JR.: Faced the ultimate test on 9/11. The "War on Terror" would change the military landscape forever.',
      'Steve almost followed his father\'s path. "It was ultra-competitive." He chose a degree instead, stepping out from the cockpit\'s shadow.',
    ],
  ...
  },
  {
    ...
    context:
      'After the Soviet collapse, America stood alone. A dangerous sense of invincibility took hold — we had won, and the world was ours. But when Steve flew to Moscow in 1997, he didn\'t see a defeated enemy; he saw a broken people.',
    findings: [
      ...
      'Steve flew into Moscow in \'97. When the door opened, the smell of economic decay was immediate.',
  ...
  },
  {
    ...
    context:
      'September 11 didn\'t just change the world; it shattered the quiet life Steve had built. Having lived in New York for years, he missed the attack by a single month — a twist of fate that would haunt him for years.',
    findings: [
      'Steve had moved from NYC to San Diego in August 2001. His daily office had been two blocks from the World Trade Center.',
  ...
  },
  {
    ...
    context:
      'History isn\'t found in textbooks; it\'s etched into the people who lived it. For Steve, the climax of this story wasn\'t a battle or a presidency. It was a quiet conversation with an old man in a kitchen, decades after the engines stopped.',
    findings: [
      'It took years for Steve and his father to finally sit down and talk — really talk — about Vietnam.',
...
export const SUBJECT_BIO = {
  ...
  context:
    'Born in 1967 at the height of the Cold War, Steve Simpson grew up in the shadow of the world\'s most powerful military machines. From the duck-and-cover drills of San Diego to the secret bunkers of NORAD and the dust of Ground Zero, his life has been a front-row seat to the making of the modern world.',
};
